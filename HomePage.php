                                            ...
                                            <div class="quick_activity_wrap">
                                                <div class="single_quick_activity d-flex">
                                                    ...
                                                    <div class="count_content">
                                                        ...
                                                        <?php
														$sel = "select count(kudumbashree_id) as id from tbl_kudumbashree";
                        ...
                        <div class="col-xl-12">
                            <div class="white_box card_height_100">
                                ...
                                <div class="staf_list_wrapper sraf_active owl-carousel">
                                    <?php
                                        $selQry = "select * from tbl_kudumbashree";
                                    ...
                                    <div class="single_staf">
                                        <div class="staf_thumb">
                                            <img src="../Assets/Files/Photo/<?php echo $data1["kudumbashree_photo"] ?>" alt="">
                                        </div>
                                        <h4><?php echo $data1["kudumbashree_name"] ?></h4>
                                        <p><?php echo $data1["kudumbashree_contact"] ?></p>
                                    </div>
                                    <?php
                                        }
                                    ?>
